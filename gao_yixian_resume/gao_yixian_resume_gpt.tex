...
\textbf{设计与剪辑工具}：
Adobe After Effects、Photoshop、达芬奇、剪映、秀米、Canva，
熟悉视频剪辑、平面设计与排版
\\

\textbf{AI 创作工具}：
ChatGPT、Gemini、DeepSeek、豆包、千问，
擅长文本生成与 Prompt 设计；
即梦、可灵、Midjourney，
能够用于图像 / 视频内容生成
\\
...
\resumeItem{
以第一作者身份在《前沿科学》（CN11-5568/N）
发表论文，
围绕 AI “魔改”经典影视剧的法律风险展开研究，
分析侵权隐患、梳理技术边界，
并提出相应应对策略。
}
...
\resumeItem{
负责人教版小学、初中教材交互板块音频导入，
使用 Audacity 分割音频文件并编号入库，
确保音频与教材内容精准匹配，
高效完成交付任务并获得公司认可。
}

\resumeItem{
同时使用 Photoshop 设计小学英语单词卡片，
输出标准化教学辅助素材。
}
