...
\end{equation}
where \(S_0(E)\) denotes the initial (nominal) reactor spectrum.
...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Img/binning strategy/segment_dmsq21.png}
    \caption{}
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Img/binning strategy/segment_sinsq12.png}
    \caption{}
