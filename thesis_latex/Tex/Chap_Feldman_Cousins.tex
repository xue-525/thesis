...
\begin{itemize}[leftmargin=*, nosep]
  ...
  \item \textbf{联合分析结果的自洽性}：在考虑反应堆模型不确定性并引入大亚湾（Daya Bay）实验对 $\Delta m^2_{31}$ 的外部约束（详见第~\ref{sec:statistical_method} 节中的pull term）后，基于 FC 构造得到的 $\Delta m^2_{31}$ 测量精度约为 $1.4\%$（50天）。
\end{itemize}
