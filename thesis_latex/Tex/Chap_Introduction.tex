...
\begin{figure}[htbp]
    ...
    \bicaption{JUNO 探测器示意图（图片来自文献\citep{Abusleme2025}）。}{Schematic view of the JUNO detector, taken from Ref.\cite{Abusleme2025}.}
    \label{fig:juno_detector}
\end{figure}

\subsection{JUNO 的探测器关键参数}
