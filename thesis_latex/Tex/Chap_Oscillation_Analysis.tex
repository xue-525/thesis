...
综上所述，本文在 Huber-Mueller 理论模型的基础上，引入了乏燃料效应与非平衡修正，并采纳大亚湾实验观测到的反应堆能谱畸变作为经验修正因子（即 5 MeV “Bump” 修正），从而得到了更加精确的反应堆出射反中微子能谱 $\phi_r'(E_\nu,t)$。如图~\ref{fig:reactor_nu_arrival} 所示，该谱线为考虑裂变产物随时间演化加权后的结果，作为后续计算到达谱与振荡折算的基准输入。进而结合恒定密度近似下的三味中微子振荡概率 $P_{ee}(E_\nu, L_r)$，即可求得探测器处的到达能谱 $\phi_{r}(E_\nu,t)$。
