...
江门中微子实验（JUNO）是中国主导的国际合作大型中微子实验，实验选址于广东省江门市开平区地下，岩石覆盖深度达到约700米。JUNO采用20千吨级液体闪烁体作为靶料，其设计目标能量分辨率优于$3\%/\sqrt{E(\rm MeV)}$，对应每MeV入射粒子至少产生1100个以上的光电子。经过多年建设，JUNO于2025年8月26日完成液体闪烁体注满并正式开始数据采集。根据方案设计，JUNO通过探测距离约53公里的阳江和台山核电站发射的反中微子能谱，精确测量中微子振荡参数并判定中微子质量顺序

\subsection{JUNO的探测器结构}

如图\ref{fig:juno_detector}所示，JUNO的核心部件是一个直径35.4米的有机玻璃球形中心探测器，内部装有约20,000吨液体闪烁体。该玻璃球被浸没在深44米、容积约3.5万吨的水切伦科夫池中，水池既屏蔽周围岩石的本底射线，又安装了光电倍增管作为水切伦科夫探测器，用于标记通过的宇宙射线μ子。中心有机玻璃球外壁均匀布置了约20000只20英寸光电倍增管和25600只3英寸光电倍增管，用于收集来自闪烁体的光信号。为了进一步抑制宇宙μ子背景，在水池顶部还安装有塑料闪烁体顶层径迹探测器，用于精确记录穿过探测器的μ子轨迹并作为μ子标记。
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{Img/JUNO_Detector_Scheme.pdf}
    \bicaption{JUNO的探测器示意图\citep{Abusleme2025}）。}{Schematic view of the JUNO detector, taken from Ref.\cite{Abusleme2025}.}
...
JUNO 协作组于 2025 年底发布了首篇反应堆中微子振荡物理结果论文《First measurement of reactor neutrino oscillations at JUNO》\citep{abusleme2025measurementreactorneutrinooscillations}。该结果基于探测器完工后自 2025 年 8 月以来的 59.1 天数据，共选取到 2379 个逆 $\beta$ 衰变（IBD）中微子候选事件。通过对中微子提示能谱的拟合分析，得到了真空三味振荡参数的高精度测量结果。
